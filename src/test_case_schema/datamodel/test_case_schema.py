...
# Generation date: 2023-09-15T10:44:07
...
class NamedThing(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = TEST_CASE_SCHEMA.NamedThing
...
slots.primary_email = Slot(uri=SCHEMA.email, name="primary_email", curie=SCHEMA.curie('email'),
                   model_uri=TEST_CASE_SCHEMA.primary_email, domain=None, range=Optional[str])

slots.birth_date = Slot(uri=SCHEMA.birthDate, name="birth_date", curie=SCHEMA.curie('birthDate'),
                   model_uri=TEST_CASE_SCHEMA.birth_date, domain=None, range=Optional[Union[str, XSDDate]])

slots.age_in_years = Slot(uri=TEST_CASE_SCHEMA.age_in_years, name="age_in_years", curie=TEST_CASE_SCHEMA.curie('age_in_years'),
                   model_uri=TEST_CASE_SCHEMA.age_in_years, domain=None, range=Optional[int])

slots.vital_status = Slot(uri=TEST_CASE_SCHEMA.vital_status, name="vital_status", curie=TEST_CASE_SCHEMA.curie('vital_status'),
                   model_uri=TEST_CASE_SCHEMA.vital_status, domain=None, range=Optional[Union[str, "PersonStatus"]])
...
slots.TestCase_primary_email = Slot(uri=SCHEMA.email, name="TestCase_primary_email", curie=SCHEMA.curie('email'),
                   model_uri=TEST_CASE_SCHEMA.TestCase_primary_email, domain=TestCase, range=Optional[str],
